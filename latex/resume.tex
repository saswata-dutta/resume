...
\begin{tightemize}
	\item Created platform for ingesting/querying relevant data in/out of our Data Lake. Added a Feature Store to version and share data for ML models. \newline (
		{\libertinesystemfont {\textbf Scala, Spark, Airflow, Python, Pandas, PySpark, AWS : Lambda, S3, Glue, Athena, EMR }}
	)
...
\runsubsection{\large{Generic Data Ingestion framework}}
\descript{| Scala, Spark}\hfill \location{github.com/saswata-dutta/spark-seed}\\
...
\runsubsection{\large{Schema aware Feature Store}}
\descript{| Python, PySpark}\hfill \location{github.com/saswata-dutta/feature-store}\\
...
\runsubsection{\large{Expression Evaluator}}
\descript{| Scala}\hfill \location{github.com/saswata-dutta/eval-exp}\\
