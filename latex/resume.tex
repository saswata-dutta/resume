...
\begin{tightemize}
    ...
    (
        {\libertinesystemfont {\textbf Scala, Spark, Airflow, Python, Pandas, PySpark, AWS : Lambda, S3, Glue, Athena}}
    )
    ...
    (
        {\libertinesystemfont {\textbf Java, Scala, Spring, Hibernate, MySql}}
    )
...
Spark based framework to ingest data from any source, and flush to any sink. Aim of project is to allow easy configuration of simple ingestion and ETL with just configuration files.\\
\sectionsep
